...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit201104
 *
 * @Table(name="dispatch_api_pnd_connection_audit_201104")
 * @Entity
 */
class DispatchApiPndConnectionAudit201104
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_201104_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
