...
/**
 * Contigo\DomainBundle\Entity\EventPowercut
 *
 * @Table(name="event_powercut")
 * @Entity
 */
class EventPowercut
{
     ...
     * @SequenceGenerator(sequenceName="event_powercut_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
