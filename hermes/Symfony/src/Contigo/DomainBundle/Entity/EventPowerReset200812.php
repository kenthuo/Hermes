...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200812
 *
 * @Table(name="event_power_reset_200812")
 * @Entity
 */
class EventPowerReset200812
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200812_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
