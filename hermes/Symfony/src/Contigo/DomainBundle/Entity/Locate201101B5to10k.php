...
/**
 * Contigo\DomainBundle\Entity\Locate201101B5to10k
 *
 * @Table(name="locate_201101_b5to10k")
 * @Entity
 */
class Locate201101B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201101_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
