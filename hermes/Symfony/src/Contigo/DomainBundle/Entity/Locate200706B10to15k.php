...
/**
 * Contigo\DomainBundle\Entity\Locate200706B10to15k
 *
 * @Table(name="locate_200706_b10to15k")
 * @Entity
 */
class Locate200706B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200706_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
