...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201102
 *
 * @Table(name="event_power_reset_201102")
 * @Entity
 */
class EventPowerReset201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
