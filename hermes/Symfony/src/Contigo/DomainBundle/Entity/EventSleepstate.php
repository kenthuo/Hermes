...
/**
 * Contigo\DomainBundle\Entity\EventSleepstate
 *
 * @Table(name="event_sleepstate")
 * @Entity
 */
class EventSleepstate
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_sleepstate_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
