...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201103
 *
 * @Table(name="event_power_reset_201103")
 * @Entity
 */
class EventPowerReset201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
