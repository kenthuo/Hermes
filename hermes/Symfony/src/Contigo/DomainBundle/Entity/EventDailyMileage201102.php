...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201102
 *
 * @Table(name="event_daily_mileage_201102")
 * @Entity
 */
class EventDailyMileage201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
