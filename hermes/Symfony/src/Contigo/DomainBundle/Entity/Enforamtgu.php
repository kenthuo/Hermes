...
/**
 * Contigo\DomainBundle\Entity\Enforamtgu
 *
 * @Table(name="enforamtgu")
 * @Entity
 */
class Enforamtgu
{
     ...
     * @SequenceGenerator(sequenceName="enforamtgu_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
    ...
    /**
     * @var bigint $gfmiActivatedTimestamp
     *
     * @Column(name="gfmi_activated_timestamp", type="bigint", nullable=true)
     */
    private $gfmiActivatedTimestamp;
