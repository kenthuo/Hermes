...
/**
 * Contigo\DomainBundle\Entity\EventLocation200801B10to15k
 *
 * @Table(name="event_location_200801_b10to15k")
 * @Entity
 */
class EventLocation200801B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_location_200801_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
