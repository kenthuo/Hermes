...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset
 *
 * @Table(name="event_odometer_reset")
 * @Entity
 */
class EventOdometerReset
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
