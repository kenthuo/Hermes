...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200910
 *
 * @Table(name="event_daily_mileage_200910")
 * @Entity
 */
class EventDailyMileage200910
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200910_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
