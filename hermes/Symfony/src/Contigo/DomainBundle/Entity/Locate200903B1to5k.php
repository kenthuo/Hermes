...
/**
 * Contigo\DomainBundle\Entity\Locate200903B1to5k
 *
 * @Table(name="locate_200903_b1to5k")
 * @Entity
 */
class Locate200903B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200903_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
