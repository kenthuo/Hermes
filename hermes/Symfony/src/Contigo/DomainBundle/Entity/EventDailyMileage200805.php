...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200805
 *
 * @Table(name="event_daily_mileage_200805")
 * @Entity
 */
class EventDailyMileage200805
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200805_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
