...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200811
 *
 * @Table(name="event_power_reset_200811")
 * @Entity
 */
class EventPowerReset200811
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200811_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
