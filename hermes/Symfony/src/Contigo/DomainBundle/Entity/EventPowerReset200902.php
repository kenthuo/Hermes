...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200902
 *
 * @Table(name="event_power_reset_200902")
 * @Entity
 */
class EventPowerReset200902
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200902_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
