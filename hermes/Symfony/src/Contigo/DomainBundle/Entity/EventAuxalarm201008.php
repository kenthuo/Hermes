...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201008
 *
 * @Table(name="event_auxalarm_201008")
 * @Entity
 */
class EventAuxalarm201008
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201008_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
