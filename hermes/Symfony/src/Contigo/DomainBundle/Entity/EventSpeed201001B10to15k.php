...
/**
 * Contigo\DomainBundle\Entity\EventSpeed201001B10to15k
 *
 * @Table(name="event_speed_201001_b10to15k")
 * @Entity
 */
class EventSpeed201001B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_speed_201001_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
