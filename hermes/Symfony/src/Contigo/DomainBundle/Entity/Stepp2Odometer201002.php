...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201002
 *
 * @Table(name="stepp2_odometer_201002")
 * @Entity
 */
class Stepp2Odometer201002
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201002_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
