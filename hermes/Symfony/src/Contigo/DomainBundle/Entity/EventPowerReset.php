...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset
 *
 * @Table(name="event_power_reset")
 * @Entity
 */
class EventPowerReset
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
