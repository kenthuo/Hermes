...
/**
 * Contigo\DomainBundle\Entity\Locate200711B1to5k
 *
 * @Table(name="locate_200711_b1to5k")
 * @Entity
 */
class Locate200711B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200711_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
