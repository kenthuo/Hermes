...
/**
 * Contigo\DomainBundle\Entity\Locate201011B1to5k
 *
 * @Table(name="locate_201011_b1to5k")
 * @Entity
 */
class Locate201011B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201011_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
