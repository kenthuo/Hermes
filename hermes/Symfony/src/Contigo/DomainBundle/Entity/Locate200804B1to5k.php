...
/**
 * Contigo\DomainBundle\Entity\Locate200804B1to5k
 *
 * @Table(name="locate_200804_b1to5k")
 * @Entity
 */
class Locate200804B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200804_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
