...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200910
 *
 * @Table(name="event_power_reset_200910")
 * @Entity
 */
class EventPowerReset200910
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200910_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
