...
/**
 * Contigo\DomainBundle\Entity\Locate201004B1to5k
 *
 * @Table(name="locate_201004_b1to5k")
 * @Entity
 */
class Locate201004B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201004_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
