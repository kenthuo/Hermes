...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201101
 *
 * @Table(name="event_auxalarm_201101")
 * @Entity
 */
class EventAuxalarm201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
