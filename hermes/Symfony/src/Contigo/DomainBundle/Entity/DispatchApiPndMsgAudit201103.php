...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201103
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201103")
 * @Entity
 */
class DispatchApiPndMsgAudit201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
