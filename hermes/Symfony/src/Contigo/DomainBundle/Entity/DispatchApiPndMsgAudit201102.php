...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201102
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201102")
 * @Entity
 */
class DispatchApiPndMsgAudit201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
