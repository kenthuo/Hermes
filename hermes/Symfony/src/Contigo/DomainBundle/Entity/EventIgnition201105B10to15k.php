...
/**
 * Contigo\DomainBundle\Entity\EventIgnition201105B10to15k
 *
 * @Table(name="event_ignition_201105_b10to15k")
 * @Entity
 */
class EventIgnition201105B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_201105_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
