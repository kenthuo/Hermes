...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201104
 *
 * @Table(name="event_daily_mileage_201104")
 * @Entity
 */
class EventDailyMileage201104
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201104_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
