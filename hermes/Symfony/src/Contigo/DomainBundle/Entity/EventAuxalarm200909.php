...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200909
 *
 * @Table(name="event_auxalarm_200909")
 * @Entity
 */
class EventAuxalarm200909
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200909_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
