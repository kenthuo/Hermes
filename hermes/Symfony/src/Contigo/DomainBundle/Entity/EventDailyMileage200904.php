...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200904
 *
 * @Table(name="event_daily_mileage_200904")
 * @Entity
 */
class EventDailyMileage200904
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200904_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
