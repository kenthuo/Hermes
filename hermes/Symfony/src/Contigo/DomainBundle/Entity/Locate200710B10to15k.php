...
/**
 * Contigo\DomainBundle\Entity\Locate200710B10to15k
 *
 * @Table(name="locate_200710_b10to15k")
 * @Entity
 */
class Locate200710B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200710_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
