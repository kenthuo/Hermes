...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201009
 *
 * @Table(name="event_auxalarm_201009")
 * @Entity
 */
class EventAuxalarm201009
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201009_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
