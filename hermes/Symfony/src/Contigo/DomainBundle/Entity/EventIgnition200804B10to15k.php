...
/**
 * Contigo\DomainBundle\Entity\EventIgnition200804B10to15k
 *
 * @Table(name="event_ignition_200804_b10to15k")
 * @Entity
 */
class EventIgnition200804B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_200804_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
