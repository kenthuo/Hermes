...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200811
 *
 * @Table(name="event_auxalarm_200811")
 * @Entity
 */
class EventAuxalarm200811
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200811_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
