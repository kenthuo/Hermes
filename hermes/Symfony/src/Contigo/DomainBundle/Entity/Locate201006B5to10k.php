...
/**
 * Contigo\DomainBundle\Entity\Locate201006B5to10k
 *
 * @Table(name="locate_201006_b5to10k")
 * @Entity
 */
class Locate201006B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201006_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
