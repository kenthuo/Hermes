...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200906
 *
 * @Table(name="event_daily_mileage_200906")
 * @Entity
 */
class EventDailyMileage200906
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200906_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
