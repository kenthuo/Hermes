...
/**
 * Contigo\DomainBundle\Entity\DrvPndDriverJob
 *
 * @Table(name="drv_pnd_driver_job")
 * @Entity
 */
class DrvPndDriverJob
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="drv_pnd_driver_job_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
