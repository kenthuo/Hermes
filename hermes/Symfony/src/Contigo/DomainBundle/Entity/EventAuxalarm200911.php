...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200911
 *
 * @Table(name="event_auxalarm_200911")
 * @Entity
 */
class EventAuxalarm200911
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200911_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
