...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm
 *
 * @Table(name="event_auxalarm")
 * @Entity
 */
class EventAuxalarm
{
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
