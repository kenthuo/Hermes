...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201105
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201105")
 * @Entity
 */
class DispatchApiPndMsgAudit201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
