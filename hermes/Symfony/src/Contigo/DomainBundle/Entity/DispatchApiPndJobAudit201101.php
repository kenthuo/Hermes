...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit201101
 *
 * @Table(name="dispatch_api_pnd_job_audit_201101")
 * @Entity
 */
class DispatchApiPndJobAudit201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
