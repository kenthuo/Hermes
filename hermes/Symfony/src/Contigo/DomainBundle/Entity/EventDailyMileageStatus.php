...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileageStatus
 *
 * @Table(name="event_daily_mileage_status")
 * @Entity
 */
class EventDailyMileageStatus
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_status_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
