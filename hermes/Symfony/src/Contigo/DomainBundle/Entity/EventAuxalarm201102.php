...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201102
 *
 * @Table(name="event_auxalarm_201102")
 * @Entity
 */
class EventAuxalarm201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
