...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201104
 *
 * @Table(name="event_auxalarm_201104")
 * @Entity
 */
class EventAuxalarm201104
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201104_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
