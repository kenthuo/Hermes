...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201105
 *
 * @Table(name="stepp2_odometer_201105")
 * @Entity
 */
class Stepp2Odometer201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
