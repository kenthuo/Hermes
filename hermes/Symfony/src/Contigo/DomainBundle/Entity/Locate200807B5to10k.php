...
/**
 * Contigo\DomainBundle\Entity\Locate200807B5to10k
 *
 * @Table(name="locate_200807_b5to10k")
 * @Entity
 */
class Locate200807B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200807_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
