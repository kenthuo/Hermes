...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit201106
 *
 * @Table(name="dispatch_api_pnd_job_audit_201106")
 * @Entity
 */
class DispatchApiPndJobAudit201106
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_201106_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
