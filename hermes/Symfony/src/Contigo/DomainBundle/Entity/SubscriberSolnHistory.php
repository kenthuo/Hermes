...
/**
 * Contigo\DomainBundle\Entity\SubscriberSolnHistory
 *
 * @Table(name="subscriber_soln_history")
 * @Entity
 */
class SubscriberSolnHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="subscriber_soln_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
