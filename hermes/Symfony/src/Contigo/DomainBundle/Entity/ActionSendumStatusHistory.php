...
/**
 * Contigo\DomainBundle\Entity\ActionSendumStatusHistory
 *
 * @Table(name="action_sendum_status_history")
 * @Entity
 */
class ActionSendumStatusHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_sendum_status_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
