...
/**
 * Contigo\DomainBundle\Entity\EventDepartlocate
 *
 * @Table(name="event_departlocate")
 * @Entity
 */
class EventDepartlocate
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_departlocate_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
