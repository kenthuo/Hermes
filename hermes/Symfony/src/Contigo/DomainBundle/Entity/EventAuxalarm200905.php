...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200905
 *
 * @Table(name="event_auxalarm_200905")
 * @Entity
 */
class EventAuxalarm200905
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200905_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
