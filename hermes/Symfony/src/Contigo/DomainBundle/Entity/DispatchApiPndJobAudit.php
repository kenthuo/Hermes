...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit
 *
 * @Table(name="dispatch_api_pnd_job_audit")
 * @Entity
 */
class DispatchApiPndJobAudit
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
