...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201101
 *
 * @Table(name="event_power_reset_201101")
 * @Entity
 */
class EventPowerReset201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
