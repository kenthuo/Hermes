...
/**
 * Contigo\DomainBundle\Entity\Locate201009B5to10k
 *
 * @Table(name="locate_201009_b5to10k")
 * @Entity
 */
class Locate201009B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201009_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
