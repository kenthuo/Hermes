...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset201010B1to5k
 *
 * @Table(name="event_odometer_reset_201010_b1to5k")
 * @Entity
 */
class EventOdometerReset201010B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_201010_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
