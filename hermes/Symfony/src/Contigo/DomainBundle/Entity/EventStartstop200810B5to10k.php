...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200810B5to10k
 *
 * @Table(name="event_startstop_200810_b5to10k")
 * @Entity
 */
class EventStartstop200810B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200810_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
