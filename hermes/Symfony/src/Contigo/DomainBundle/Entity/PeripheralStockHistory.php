...
/**
 * Contigo\DomainBundle\Entity\PeripheralStockHistory
 *
 * @Table(name="peripheral_stock_history")
 * @Entity
 */
class PeripheralStockHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="peripheral_stock_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
