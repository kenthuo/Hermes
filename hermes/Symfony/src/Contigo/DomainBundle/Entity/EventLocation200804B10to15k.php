...
/**
 * Contigo\DomainBundle\Entity\EventLocation200804B10to15k
 *
 * @Table(name="event_location_200804_b10to15k")
 * @Entity
 */
class EventLocation200804B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_location_200804_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
