...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201004
 *
 * @Table(name="event_daily_mileage_201004")
 * @Entity
 */
class EventDailyMileage201004
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201004_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
