...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset200902B5to10k
 *
 * @Table(name="event_odometer_reset_200902_b5to10k")
 * @Entity
 */
class EventOdometerReset200902B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_200902_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
