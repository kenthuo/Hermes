...
/**
 * Contigo\DomainBundle\Entity\EventMotionDetector
 *
 * @Table(name="event_motion_detector")
 * @Entity
 */
class EventMotionDetector
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_motion_detector_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
