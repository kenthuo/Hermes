...
/**
 * Contigo\DomainBundle\Entity\EventDooropened
 *
 * @Table(name="event_dooropened")
 * @Entity
 */
class EventDooropened
{
     ...
     * @SequenceGenerator(sequenceName="event_dooropened_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
