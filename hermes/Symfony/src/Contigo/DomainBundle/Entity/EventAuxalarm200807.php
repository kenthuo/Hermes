...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200807
 *
 * @Table(name="event_auxalarm_200807")
 * @Entity
 */
class EventAuxalarm200807
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200807_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
