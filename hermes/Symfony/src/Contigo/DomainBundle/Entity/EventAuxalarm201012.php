...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201012
 *
 * @Table(name="event_auxalarm_201012")
 * @Entity
 */
class EventAuxalarm201012
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201012_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
