...
/**
 * Contigo\DomainBundle\Entity\Locate200802B5to10k
 *
 * @Table(name="locate_200802_b5to10k")
 * @Entity
 */
class Locate200802B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200802_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
