...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200805
 *
 * @Table(name="event_power_reset_200805")
 * @Entity
 */
class EventPowerReset200805
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200805_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
