...
/**
 * Contigo\DomainBundle\Entity\EventIgnition201007B10to15k
 *
 * @Table(name="event_ignition_201007_b10to15k")
 * @Entity
 */
class EventIgnition201007B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_201007_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
