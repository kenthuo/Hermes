...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200804
 *
 * @Table(name="event_auxalarm_200804")
 * @Entity
 */
class EventAuxalarm200804
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200804_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
