...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200903
 *
 * @Table(name="event_daily_mileage_200903")
 * @Entity
 */
class EventDailyMileage200903
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200903_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
