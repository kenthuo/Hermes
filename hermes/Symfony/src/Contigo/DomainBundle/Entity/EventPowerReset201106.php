...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201106
 *
 * @Table(name="event_power_reset_201106")
 * @Entity
 */
class EventPowerReset201106
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201106_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
