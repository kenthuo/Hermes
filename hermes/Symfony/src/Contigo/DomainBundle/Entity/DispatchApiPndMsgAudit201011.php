...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201011
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201011")
 * @Entity
 */
class DispatchApiPndMsgAudit201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
