...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200902
 *
 * @Table(name="event_daily_mileage_200902")
 * @Entity
 */
class EventDailyMileage200902
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200902_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
