...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200906
 *
 * @Table(name="event_power_reset_200906")
 * @Entity
 */
class EventPowerReset200906
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200906_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
