...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200812
 *
 * @Table(name="event_daily_mileage_200812")
 * @Entity
 */
class EventDailyMileage200812
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200812_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
