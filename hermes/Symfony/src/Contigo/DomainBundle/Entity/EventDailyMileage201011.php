...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201011
 *
 * @Table(name="event_daily_mileage_201011")
 * @Entity
 */
class EventDailyMileage201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
