...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201101
 *
 * @Table(name="stepp2_odometer_201101")
 * @Entity
 */
class Stepp2Odometer201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
