...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201008
 *
 * @Table(name="stepp2_odometer_201008")
 * @Entity
 */
class Stepp2Odometer201008
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201008_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
