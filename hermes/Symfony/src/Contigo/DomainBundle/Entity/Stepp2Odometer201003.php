...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201003
 *
 * @Table(name="stepp2_odometer_201003")
 * @Entity
 */
class Stepp2Odometer201003
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201003_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
