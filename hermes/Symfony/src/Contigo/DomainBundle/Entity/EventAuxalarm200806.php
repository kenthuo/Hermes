...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200806
 *
 * @Table(name="event_auxalarm_200806")
 * @Entity
 */
class EventAuxalarm200806
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200806_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
