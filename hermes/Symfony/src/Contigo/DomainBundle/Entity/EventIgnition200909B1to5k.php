...
/**
 * Contigo\DomainBundle\Entity\EventIgnition200909B1to5k
 *
 * @Table(name="event_ignition_200909_b1to5k")
 * @Entity
 */
class EventIgnition200909B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_200909_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
