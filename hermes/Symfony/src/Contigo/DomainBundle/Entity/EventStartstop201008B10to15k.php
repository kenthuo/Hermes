...
/**
 * Contigo\DomainBundle\Entity\EventStartstop201008B10to15k
 *
 * @Table(name="event_startstop_201008_b10to15k")
 * @Entity
 */
class EventStartstop201008B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_201008_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
