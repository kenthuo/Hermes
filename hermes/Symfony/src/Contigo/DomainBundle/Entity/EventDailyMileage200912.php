...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200912
 *
 * @Table(name="event_daily_mileage_200912")
 * @Entity
 */
class EventDailyMileage200912
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200912_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
