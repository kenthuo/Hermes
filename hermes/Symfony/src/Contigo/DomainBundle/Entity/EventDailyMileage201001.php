...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201001
 *
 * @Table(name="event_daily_mileage_201001")
 * @Entity
 */
class EventDailyMileage201001
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201001_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
