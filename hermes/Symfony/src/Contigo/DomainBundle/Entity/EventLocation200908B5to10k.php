...
/**
 * Contigo\DomainBundle\Entity\EventLocation200908B5to10k
 *
 * @Table(name="event_location_200908_b5to10k")
 * @Entity
 */
class EventLocation200908B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_location_200908_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
