...
/**
 * Contigo\DomainBundle\Entity\Locate200809B10to15k
 *
 * @Table(name="locate_200809_b10to15k")
 * @Entity
 */
class Locate200809B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200809_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
