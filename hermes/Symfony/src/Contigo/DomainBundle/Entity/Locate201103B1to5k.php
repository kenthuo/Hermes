...
/**
 * Contigo\DomainBundle\Entity\Locate201103B1to5k
 *
 * @Table(name="locate_201103_b1to5k")
 * @Entity
 */
class Locate201103B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201103_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
