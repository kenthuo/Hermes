...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200807
 *
 * @Table(name="event_power_reset_200807")
 * @Entity
 */
class EventPowerReset200807
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200807_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
