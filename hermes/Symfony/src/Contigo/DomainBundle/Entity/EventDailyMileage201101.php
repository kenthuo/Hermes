...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201101
 *
 * @Table(name="event_daily_mileage_201101")
 * @Entity
 */
class EventDailyMileage201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
