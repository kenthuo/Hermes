...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit201011
 *
 * @Table(name="dispatch_api_pnd_connection_audit_201011")
 * @Entity
 */
class DispatchApiPndConnectionAudit201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
