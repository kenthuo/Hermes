...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage
 *
 * @Table(name="event_daily_mileage")
 * @Entity
 */
class EventDailyMileage
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
