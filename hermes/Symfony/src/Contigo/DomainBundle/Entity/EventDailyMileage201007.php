...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201007
 *
 * @Table(name="event_daily_mileage_201007")
 * @Entity
 */
class EventDailyMileage201007
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201007_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
