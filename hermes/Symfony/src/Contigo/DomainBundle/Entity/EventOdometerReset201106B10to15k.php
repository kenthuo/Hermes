...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset201106B10to15k
 *
 * @Table(name="event_odometer_reset_201106_b10to15k")
 * @Entity
 */
class EventOdometerReset201106B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_201106_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
