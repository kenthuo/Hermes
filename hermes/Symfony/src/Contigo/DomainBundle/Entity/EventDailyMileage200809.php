...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200809
 *
 * @Table(name="event_daily_mileage_200809")
 * @Entity
 */
class EventDailyMileage200809
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200809_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
