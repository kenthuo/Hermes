...
/**
 * Contigo\DomainBundle\Entity\EventSpeed200709B5to10k
 *
 * @Table(name="event_speed_200709_b5to10k")
 * @Entity
 */
class EventSpeed200709B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_speed_200709_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
