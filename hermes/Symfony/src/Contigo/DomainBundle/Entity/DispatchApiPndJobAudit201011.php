...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit201011
 *
 * @Table(name="dispatch_api_pnd_job_audit_201011")
 * @Entity
 */
class DispatchApiPndJobAudit201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
