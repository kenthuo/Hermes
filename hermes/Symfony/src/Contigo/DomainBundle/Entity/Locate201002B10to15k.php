...
/**
 * Contigo\DomainBundle\Entity\Locate201002B10to15k
 *
 * @Table(name="locate_201002_b10to15k")
 * @Entity
 */
class Locate201002B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201002_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
