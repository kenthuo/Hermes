...
/**
 * Contigo\DomainBundle\Entity\EventPanicCancel
 *
 * @Table(name="event_panic_cancel")
 * @Entity
 */
class EventPanicCancel
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_panic_cancel_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
