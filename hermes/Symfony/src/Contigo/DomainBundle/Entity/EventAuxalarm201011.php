...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201011
 *
 * @Table(name="event_auxalarm_201011")
 * @Entity
 */
class EventAuxalarm201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
