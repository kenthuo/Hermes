...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201007
 *
 * @Table(name="event_auxalarm_201007")
 * @Entity
 */
class EventAuxalarm201007
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201007_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
