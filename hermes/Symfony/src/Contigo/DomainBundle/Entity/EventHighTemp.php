...
/**
 * Contigo\DomainBundle\Entity\EventHighTemp
 *
 * @Table(name="event_high_temp")
 * @Entity
 */
class EventHighTemp
{
     ...
     * @SequenceGenerator(sequenceName="event_high_temp_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
