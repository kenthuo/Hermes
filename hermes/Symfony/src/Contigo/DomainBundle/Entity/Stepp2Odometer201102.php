...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201102
 *
 * @Table(name="stepp2_odometer_201102")
 * @Entity
 */
class Stepp2Odometer201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
