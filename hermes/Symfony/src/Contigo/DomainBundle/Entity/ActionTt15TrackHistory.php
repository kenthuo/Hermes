...
/**
 * Contigo\DomainBundle\Entity\ActionTt15TrackHistory
 *
 * @Table(name="action_tt15_track_history")
 * @Entity
 */
class ActionTt15TrackHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_tt15_track_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
