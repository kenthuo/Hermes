...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset200709B10to15k
 *
 * @Table(name="event_odometer_reset_200709_b10to15k")
 * @Entity
 */
class EventOdometerReset200709B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_200709_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
