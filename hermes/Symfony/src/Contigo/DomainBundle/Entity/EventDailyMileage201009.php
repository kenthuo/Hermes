...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201009
 *
 * @Table(name="event_daily_mileage_201009")
 * @Entity
 */
class EventDailyMileage201009
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201009_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
