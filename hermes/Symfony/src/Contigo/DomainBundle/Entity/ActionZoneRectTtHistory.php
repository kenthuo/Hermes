...
/**
 * Contigo\DomainBundle\Entity\ActionZoneRectTtHistory
 *
 * @Table(name="action_zone_rect_tt_history")
 * @Entity
 */
class ActionZoneRectTtHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_zone_rect_tt_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
