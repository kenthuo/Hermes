...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201011
 *
 * @Table(name="stepp2_odometer_201011")
 * @Entity
 */
class Stepp2Odometer201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
