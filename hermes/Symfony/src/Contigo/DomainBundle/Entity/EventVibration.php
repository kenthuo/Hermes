...
/**
 * Contigo\DomainBundle\Entity\EventVibration
 *
 * @Table(name="event_vibration")
 * @Entity
 */
class EventVibration
{
     ...
     * @SequenceGenerator(sequenceName="event_vibration_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
