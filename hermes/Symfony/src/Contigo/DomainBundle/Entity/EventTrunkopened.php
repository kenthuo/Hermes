...
/**
 * Contigo\DomainBundle\Entity\EventTrunkopened
 *
 * @Table(name="event_trunkopened")
 * @Entity
 */
class EventTrunkopened
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_trunkopened_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
