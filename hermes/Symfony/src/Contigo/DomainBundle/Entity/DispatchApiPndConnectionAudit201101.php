...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit201101
 *
 * @Table(name="dispatch_api_pnd_connection_audit_201101")
 * @Entity
 */
class DispatchApiPndConnectionAudit201101
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_201101_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
