...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201010
 *
 * @Table(name="event_power_reset_201010")
 * @Entity
 */
class EventPowerReset201010
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201010_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
