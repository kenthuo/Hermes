...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200904B5to10k
 *
 * @Table(name="event_startstop_200904_b5to10k")
 * @Entity
 */
class EventStartstop200904B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200904_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
