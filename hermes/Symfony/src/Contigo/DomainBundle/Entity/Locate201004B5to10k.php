...
/**
 * Contigo\DomainBundle\Entity\Locate201004B5to10k
 *
 * @Table(name="locate_201004_b5to10k")
 * @Entity
 */
class Locate201004B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201004_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
