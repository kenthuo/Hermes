...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200811B10to15k
 *
 * @Table(name="event_startstop_200811_b10to15k")
 * @Entity
 */
class EventStartstop200811B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200811_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
