...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200804
 *
 * @Table(name="event_daily_mileage_200804")
 * @Entity
 */
class EventDailyMileage200804
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200804_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
