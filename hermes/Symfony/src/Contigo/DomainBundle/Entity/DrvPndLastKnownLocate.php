...
/**
 * Contigo\DomainBundle\Entity\DrvPndLastKnownLocate
 *
 * @Table(name="drv_pnd_last_known_locate")
 * @Entity
 */
class DrvPndLastKnownLocate
{
    /**
     ...
     * @SequenceGenerator(sequenceName="drv_pnd_last_known_locate_guardian_id_seq", allocationSize="1", initialValue="1")
     */
    private $guardianId;
