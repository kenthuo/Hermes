...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201001
 *
 * @Table(name="stepp2_odometer_201001")
 * @Entity
 */
class Stepp2Odometer201001
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201001_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
