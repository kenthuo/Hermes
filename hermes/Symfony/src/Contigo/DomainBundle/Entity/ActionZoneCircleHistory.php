...
/**
 * Contigo\DomainBundle\Entity\ActionZoneCircleHistory
 *
 * @Table(name="action_zone_circle_history")
 * @Entity
 */
class ActionZoneCircleHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_zone_circle_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
