...
/**
 * Contigo\DomainBundle\Entity\Locate201010B5to10k
 *
 * @Table(name="locate_201010_b5to10k")
 * @Entity
 */
class Locate201010B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201010_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
