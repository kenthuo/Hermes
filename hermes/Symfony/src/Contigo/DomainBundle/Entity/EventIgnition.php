...
/**
 * Contigo\DomainBundle\Entity\EventIgnition
 *
 * @Table(name="event_ignition")
 * @Entity
 */
class EventIgnition
{
     ...
     * @SequenceGenerator(sequenceName="event_ignition_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
