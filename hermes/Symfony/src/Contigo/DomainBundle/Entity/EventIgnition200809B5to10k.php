...
/**
 * Contigo\DomainBundle\Entity\EventIgnition200809B5to10k
 *
 * @Table(name="event_ignition_200809_b5to10k")
 * @Entity
 */
class EventIgnition200809B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_200809_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
