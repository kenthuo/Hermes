...
/**
 * Contigo\DomainBundle\Entity\EventLocation200705B10to15k
 *
 * @Table(name="event_location_200705_b10to15k")
 * @Entity
 */
class EventLocation200705B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_location_200705_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
