...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201003
 *
 * @Table(name="event_power_reset_201003")
 * @Entity
 */
class EventPowerReset201003
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201003_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
