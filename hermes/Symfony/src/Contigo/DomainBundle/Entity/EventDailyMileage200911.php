...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200911
 *
 * @Table(name="event_daily_mileage_200911")
 * @Entity
 */
class EventDailyMileage200911
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200911_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
