...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201105
 *
 * @Table(name="event_power_reset_201105")
 * @Entity
 */
class EventPowerReset201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
