...
/**
 * Contigo\DomainBundle\Entity\DepartmentAsset
 *
 * @Table(name="department_asset")
 * @Entity
 */
class DepartmentAsset
{
     ...
     * @SequenceGenerator(sequenceName="department_asset_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
