...
/**
 * Contigo\DomainBundle\Entity\EventIgnition201106B1to5k
 *
 * @Table(name="event_ignition_201106_b1to5k")
 * @Entity
 */
class EventIgnition201106B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_201106_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
