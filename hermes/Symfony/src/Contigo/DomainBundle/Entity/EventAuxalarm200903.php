...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200903
 *
 * @Table(name="event_auxalarm_200903")
 * @Entity
 */
class EventAuxalarm200903
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200903_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
