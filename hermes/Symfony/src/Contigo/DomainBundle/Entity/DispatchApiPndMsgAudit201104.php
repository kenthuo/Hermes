...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201104
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201104")
 * @Entity
 */
class DispatchApiPndMsgAudit201104
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201104_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
