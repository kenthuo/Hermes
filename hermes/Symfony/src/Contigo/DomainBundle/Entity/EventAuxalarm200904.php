...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200904
 *
 * @Table(name="event_auxalarm_200904")
 * @Entity
 */
class EventAuxalarm200904
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200904_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
