...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201008
 *
 * @Table(name="event_power_reset_201008")
 * @Entity
 */
class EventPowerReset201008
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201008_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
