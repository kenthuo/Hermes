...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit
 *
 * @Table(name="dispatch_api_pnd_msg_audit")
 * @Entity
 */
class DispatchApiPndMsgAudit
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
