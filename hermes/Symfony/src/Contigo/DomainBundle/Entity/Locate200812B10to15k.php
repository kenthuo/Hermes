...
/**
 * Contigo\DomainBundle\Entity\Locate200812B10to15k
 *
 * @Table(name="locate_200812_b10to15k")
 * @Entity
 */
class Locate200812B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200812_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
