...
/**
 * Contigo\DomainBundle\Entity\Enforamt
 *
 * @Table(name="enforamt")
 * @Entity
 */
class Enforamt
{
     ...
     * @SequenceGenerator(sequenceName="enforamt_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
    ...
    /**
     * @var integer $wakeintvl
     *
     * @Column(name="wakeintvl", type="integer", nullable=true)
     */
    private $wakeintvl;

    /**
     * @var integer $waketime
     *
     * @Column(name="waketime", type="integer", nullable=true)
     */
    private $waketime;

    /**
     * @var integer $mottrans
     *
     * @Column(name="mottrans", type="integer", nullable=true)
     */
    private $mottrans;
