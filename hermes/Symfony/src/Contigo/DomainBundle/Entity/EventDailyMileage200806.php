...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200806
 *
 * @Table(name="event_daily_mileage_200806")
 * @Entity
 */
class EventDailyMileage200806
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200806_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
