...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200907
 *
 * @Table(name="event_power_reset_200907")
 * @Entity
 */
class EventPowerReset200907
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200907_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
