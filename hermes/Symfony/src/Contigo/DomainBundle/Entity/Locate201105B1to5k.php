...
/**
 * Contigo\DomainBundle\Entity\Locate201105B1to5k
 *
 * @Table(name="locate_201105_b1to5k")
 * @Entity
 */
class Locate201105B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201105_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
