...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201005
 *
 * @Table(name="event_power_reset_201005")
 * @Entity
 */
class EventPowerReset201005
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201005_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
