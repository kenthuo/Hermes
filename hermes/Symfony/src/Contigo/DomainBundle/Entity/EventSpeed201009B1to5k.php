...
/**
 * Contigo\DomainBundle\Entity\EventSpeed201009B1to5k
 *
 * @Table(name="event_speed_201009_b1to5k")
 * @Entity
 */
class EventSpeed201009B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_speed_201009_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
