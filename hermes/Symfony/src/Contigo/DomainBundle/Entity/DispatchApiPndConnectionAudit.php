...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit
 *
 * @Table(name="dispatch_api_pnd_connection_audit")
 * @Entity
 */
class DispatchApiPndConnectionAudit
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
