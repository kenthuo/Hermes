...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201103
 *
 * @Table(name="event_auxalarm_201103")
 * @Entity
 */
class EventAuxalarm201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
