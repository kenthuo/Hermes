...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201001
 *
 * @Table(name="event_auxalarm_201001")
 * @Entity
 */
class EventAuxalarm201001
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201001_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
