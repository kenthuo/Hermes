...
/**
 * Contigo\DomainBundle\Entity\EventStartstop201103B10to15k
 *
 * @Table(name="event_startstop_201103_b10to15k")
 * @Entity
 */
class EventStartstop201103B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_201103_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
