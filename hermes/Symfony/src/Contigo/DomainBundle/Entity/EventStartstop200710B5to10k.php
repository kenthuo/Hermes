...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200710B5to10k
 *
 * @Table(name="event_startstop_200710_b5to10k")
 * @Entity
 */
class EventStartstop200710B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200710_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
