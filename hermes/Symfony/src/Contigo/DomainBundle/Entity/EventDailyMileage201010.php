...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201010
 *
 * @Table(name="event_daily_mileage_201010")
 * @Entity
 */
class EventDailyMileage201010
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201010_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
