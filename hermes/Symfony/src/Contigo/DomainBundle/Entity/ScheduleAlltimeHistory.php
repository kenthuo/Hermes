...
/**
 * Contigo\DomainBundle\Entity\ScheduleAlltimeHistory
 *
 * @Table(name="schedule_alltime_history")
 * @Entity
 */
class ScheduleAlltimeHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="schedule_alltime_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
