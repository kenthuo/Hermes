...
/**
 * Contigo\DomainBundle\Entity\Locate200812B1to5k
 *
 * @Table(name="locate_200812_b1to5k")
 * @Entity
 */
class Locate200812B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200812_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
