...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200806
 *
 * @Table(name="event_power_reset_200806")
 * @Entity
 */
class EventPowerReset200806
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200806_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
