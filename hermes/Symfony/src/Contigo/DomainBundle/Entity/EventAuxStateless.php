...
/**
 * Contigo\DomainBundle\Entity\EventAuxStateless
 *
 * @Table(name="event_aux_stateless")
 * @Entity
 */
class EventAuxStateless
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_aux_stateless_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
