...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201010
 *
 * @Table(name="event_auxalarm_201010")
 * @Entity
 */
class EventAuxalarm201010
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201010_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
