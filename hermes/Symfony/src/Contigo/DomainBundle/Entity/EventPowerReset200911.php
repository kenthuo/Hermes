...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200911
 *
 * @Table(name="event_power_reset_200911")
 * @Entity
 */
class EventPowerReset200911
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200911_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
