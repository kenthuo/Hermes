...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200903
 *
 * @Table(name="event_power_reset_200903")
 * @Entity
 */
class EventPowerReset200903
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200903_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
