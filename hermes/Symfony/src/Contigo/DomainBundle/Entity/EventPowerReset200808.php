...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200808
 *
 * @Table(name="event_power_reset_200808")
 * @Entity
 */
class EventPowerReset200808
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200808_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
