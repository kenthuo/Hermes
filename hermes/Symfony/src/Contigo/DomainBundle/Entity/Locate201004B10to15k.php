...
/**
 * Contigo\DomainBundle\Entity\Locate201004B10to15k
 *
 * @Table(name="locate_201004_b10to15k")
 * @Entity
 */
class Locate201004B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201004_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
