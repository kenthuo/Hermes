...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer
 *
 * @Table(name="stepp2_odometer")
 * @Entity
 */
class Stepp2Odometer
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
