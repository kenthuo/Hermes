...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201103
 *
 * @Table(name="stepp2_odometer_201103")
 * @Entity
 */
class Stepp2Odometer201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
