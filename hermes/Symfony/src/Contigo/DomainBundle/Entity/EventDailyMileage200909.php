...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200909
 *
 * @Table(name="event_daily_mileage_200909")
 * @Entity
 */
class EventDailyMileage200909
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200909_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
