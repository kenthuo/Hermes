...
/**
 * Contigo\DomainBundle\Entity\EventAuxOutput
 *
 * @Table(name="event_aux_output")
 * @Entity
 */
class EventAuxOutput
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_aux_output_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
     ...
     *
     * @Column(name="output_name", type="string", length=100, nullable=true)
     */
    private $outputName;
