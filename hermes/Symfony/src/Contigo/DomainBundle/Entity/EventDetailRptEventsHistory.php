...
/**
 * Contigo\DomainBundle\Entity\EventDetailRptEventsHistory
 *
 * @Table(name="event_detail_rpt_events_history")
 * @Entity
 */
class EventDetailRptEventsHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_detail_rpt_events_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
