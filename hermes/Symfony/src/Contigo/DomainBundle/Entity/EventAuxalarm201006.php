...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201006
 *
 * @Table(name="event_auxalarm_201006")
 * @Entity
 */
class EventAuxalarm201006
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201006_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
