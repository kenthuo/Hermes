...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201103
 *
 * @Table(name="event_daily_mileage_201103")
 * @Entity
 */
class EventDailyMileage201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
