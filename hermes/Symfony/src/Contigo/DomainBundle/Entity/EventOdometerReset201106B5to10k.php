...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset201106B5to10k
 *
 * @Table(name="event_odometer_reset_201106_b5to10k")
 * @Entity
 */
class EventOdometerReset201106B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_201106_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
