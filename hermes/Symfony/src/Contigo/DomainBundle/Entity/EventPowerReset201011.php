...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201011
 *
 * @Table(name="event_power_reset_201011")
 * @Entity
 */
class EventPowerReset201011
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201011_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
