...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit201010
 *
 * @Table(name="dispatch_api_pnd_job_audit_201010")
 * @Entity
 */
class DispatchApiPndJobAudit201010
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_201010_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
