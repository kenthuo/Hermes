...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200905
 *
 * @Table(name="event_power_reset_200905")
 * @Entity
 */
class EventPowerReset200905
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200905_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
