...
/**
 * Contigo\DomainBundle\Entity\Locate200811B5to10k
 *
 * @Table(name="locate_200811_b5to10k")
 * @Entity
 */
class Locate200811B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200811_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
