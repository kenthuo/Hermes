...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit201103
 *
 * @Table(name="dispatch_api_pnd_connection_audit_201103")
 * @Entity
 */
class DispatchApiPndConnectionAudit201103
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_201103_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
