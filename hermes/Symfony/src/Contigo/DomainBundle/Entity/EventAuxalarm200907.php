...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200907
 *
 * @Table(name="event_auxalarm_200907")
 * @Entity
 */
class EventAuxalarm200907
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200907_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
