...
/**
 * Contigo\DomainBundle\Entity\EventCallback
 *
 * @Table(name="event_callback")
 * @Entity
 */
class EventCallback
{
     ...
     * @SequenceGenerator(sequenceName="event_callback_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
