...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200910
 *
 * @Table(name="event_auxalarm_200910")
 * @Entity
 */
class EventAuxalarm200910
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200910_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
