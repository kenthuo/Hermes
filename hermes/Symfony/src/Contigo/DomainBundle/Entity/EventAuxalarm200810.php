...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200810
 *
 * @Table(name="event_auxalarm_200810")
 * @Entity
 */
class EventAuxalarm200810
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200810_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
