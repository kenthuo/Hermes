...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200804
 *
 * @Table(name="event_power_reset_200804")
 * @Entity
 */
class EventPowerReset200804
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200804_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
