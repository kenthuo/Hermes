...
/**
 * Contigo\DomainBundle\Entity\StopRptHistory
 *
 * @Table(name="stop_rpt_history")
 * @Entity
 */
class StopRptHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stop_rpt_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
