...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201009
 *
 * @Table(name="event_power_reset_201009")
 * @Entity
 */
class EventPowerReset201009
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201009_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
