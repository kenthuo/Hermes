...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200912
 *
 * @Table(name="event_auxalarm_200912")
 * @Entity
 */
class EventAuxalarm200912
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200912_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
