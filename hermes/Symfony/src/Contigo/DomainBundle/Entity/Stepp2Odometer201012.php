...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201012
 *
 * @Table(name="stepp2_odometer_201012")
 * @Entity
 */
class Stepp2Odometer201012
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201012_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
