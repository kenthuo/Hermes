...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201106
 *
 * @Table(name="event_auxalarm_201106")
 * @Entity
 */
class EventAuxalarm201106
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201106_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
