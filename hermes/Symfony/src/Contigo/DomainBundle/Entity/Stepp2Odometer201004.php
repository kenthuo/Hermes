...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201004
 *
 * @Table(name="stepp2_odometer_201004")
 * @Entity
 */
class Stepp2Odometer201004
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201004_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
