...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200904
 *
 * @Table(name="event_power_reset_200904")
 * @Entity
 */
class EventPowerReset200904
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200904_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
