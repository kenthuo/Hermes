...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200809
 *
 * @Table(name="event_auxalarm_200809")
 * @Entity
 */
class EventAuxalarm200809
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200809_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
