...
/**
 * Contigo\DomainBundle\Entity\BeaconRecurProfile
 *
 * @Table(name="beacon_recur_profile")
 * @Entity
 */
class BeaconRecurProfile
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="beacon_recur_profile_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
    ...
    /**
     * @var float $monthlyBasicPlanCost
     *
     * @Column(name="monthly_basic_plan_cost", type="float", nullable=true)
     */
    private $monthlyBasicPlanCost;
