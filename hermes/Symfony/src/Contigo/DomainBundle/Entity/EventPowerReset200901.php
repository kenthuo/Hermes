...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200901
 *
 * @Table(name="event_power_reset_200901")
 * @Entity
 */
class EventPowerReset200901
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200901_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
