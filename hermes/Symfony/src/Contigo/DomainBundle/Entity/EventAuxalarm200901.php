...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200901
 *
 * @Table(name="event_auxalarm_200901")
 * @Entity
 */
class EventAuxalarm200901
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200901_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
