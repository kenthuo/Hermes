...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201012
 *
 * @Table(name="event_daily_mileage_201012")
 * @Entity
 */
class EventDailyMileage201012
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201012_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
