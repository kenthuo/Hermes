...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200805
 *
 * @Table(name="event_auxalarm_200805")
 * @Entity
 */
class EventAuxalarm200805
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200805_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
