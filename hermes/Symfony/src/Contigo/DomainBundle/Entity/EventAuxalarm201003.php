...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201003
 *
 * @Table(name="event_auxalarm_201003")
 * @Entity
 */
class EventAuxalarm201003
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201003_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
