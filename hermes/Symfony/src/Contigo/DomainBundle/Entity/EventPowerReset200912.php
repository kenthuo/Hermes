...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200912
 *
 * @Table(name="event_power_reset_200912")
 * @Entity
 */
class EventPowerReset200912
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200912_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
