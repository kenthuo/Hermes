...
/**
 * Contigo\DomainBundle\Entity\EventIgnition200811B10to15k
 *
 * @Table(name="event_ignition_200811_b10to15k")
 * @Entity
 */
class EventIgnition200811B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_200811_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
