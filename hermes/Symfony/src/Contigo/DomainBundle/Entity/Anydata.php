...
/**
 * Contigo\DomainBundle\Entity\Anydata
 *
 * @Table(name="anydata")
 * @Entity
 */
class Anydata
{
     ...
     * @SequenceGenerator(sequenceName="anydata_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
     ...
     *
     * @Column(name="phone_number", type="string", length=20, nullable=false)
     */
    private $phoneNumber;
