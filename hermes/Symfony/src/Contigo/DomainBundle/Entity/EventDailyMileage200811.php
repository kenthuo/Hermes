...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200811
 *
 * @Table(name="event_daily_mileage_200811")
 * @Entity
 */
class EventDailyMileage200811
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200811_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
