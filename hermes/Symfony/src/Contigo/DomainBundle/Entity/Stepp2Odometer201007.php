...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201007
 *
 * @Table(name="stepp2_odometer_201007")
 * @Entity
 */
class Stepp2Odometer201007
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201007_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
