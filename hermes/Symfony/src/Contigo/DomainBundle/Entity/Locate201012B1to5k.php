...
/**
 * Contigo\DomainBundle\Entity\Locate201012B1to5k
 *
 * @Table(name="locate_201012_b1to5k")
 * @Entity
 */
class Locate201012B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_201012_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
