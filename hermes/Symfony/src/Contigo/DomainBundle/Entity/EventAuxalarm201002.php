...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201002
 *
 * @Table(name="event_auxalarm_201002")
 * @Entity
 */
class EventAuxalarm201002
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201002_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
