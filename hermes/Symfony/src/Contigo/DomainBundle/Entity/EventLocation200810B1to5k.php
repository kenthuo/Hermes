...
/**
 * Contigo\DomainBundle\Entity\EventLocation200810B1to5k
 *
 * @Table(name="event_location_200810_b1to5k")
 * @Entity
 */
class EventLocation200810B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_location_200810_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
