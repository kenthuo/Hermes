...
/**
 * Contigo\DomainBundle\Entity\EventIgnition201104B10to15k
 *
 * @Table(name="event_ignition_201104_b10to15k")
 * @Entity
 */
class EventIgnition201104B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_201104_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
