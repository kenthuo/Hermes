...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200808
 *
 * @Table(name="event_daily_mileage_200808")
 * @Entity
 */
class EventDailyMileage200808
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200808_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
