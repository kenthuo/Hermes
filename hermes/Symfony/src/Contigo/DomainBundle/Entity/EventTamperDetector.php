...
/**
 * Contigo\DomainBundle\Entity\EventTamperDetector
 *
 * @Table(name="event_tamper_detector")
 * @Entity
 */
class EventTamperDetector
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_tamper_detector_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
