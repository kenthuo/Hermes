...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200908
 *
 * @Table(name="event_power_reset_200908")
 * @Entity
 */
class EventPowerReset200908
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200908_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
