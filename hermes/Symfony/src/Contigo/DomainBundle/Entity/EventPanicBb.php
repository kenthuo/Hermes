...
/**
 * Contigo\DomainBundle\Entity\EventPanicBb
 *
 * @Table(name="event_panic_bb")
 * @Entity
 */
class EventPanicBb
{
     ...
     * @SequenceGenerator(sequenceName="event_panic_bb_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
    ...
    /**
     * @var smallint $isCancelPanic
     *
     * @Column(name="is_cancel_panic", type="smallint", nullable=false)
     */
