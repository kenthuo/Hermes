...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200901
 *
 * @Table(name="event_daily_mileage_200901")
 * @Entity
 */
class EventDailyMileage200901
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200901_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
