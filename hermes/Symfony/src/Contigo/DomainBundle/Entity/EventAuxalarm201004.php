...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201004
 *
 * @Table(name="event_auxalarm_201004")
 * @Entity
 */
class EventAuxalarm201004
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201004_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
