...
/**
 * Contigo\DomainBundle\Entity\EventVoltchange
 *
 * @Table(name="event_voltchange")
 * @Entity
 */
class EventVoltchange
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_voltchange_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
