...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200808
 *
 * @Table(name="event_auxalarm_200808")
 * @Entity
 */
class EventAuxalarm200808
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200808_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
