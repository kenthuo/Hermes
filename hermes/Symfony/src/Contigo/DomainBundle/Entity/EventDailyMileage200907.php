...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200907
 *
 * @Table(name="event_daily_mileage_200907")
 * @Entity
 */
class EventDailyMileage200907
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200907_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
