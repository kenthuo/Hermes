...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201010
 *
 * @Table(name="stepp2_odometer_201010")
 * @Entity
 */
class Stepp2Odometer201010
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201010_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
