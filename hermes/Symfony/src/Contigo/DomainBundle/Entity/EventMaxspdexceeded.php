...
/**
 * Contigo\DomainBundle\Entity\EventMaxspdexceeded
 *
 * @Table(name="event_maxspdexceeded")
 * @Entity
 */
class EventMaxspdexceeded
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_maxspdexceeded_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
