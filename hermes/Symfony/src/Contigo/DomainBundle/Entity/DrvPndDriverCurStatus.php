...
/**
 * Contigo\DomainBundle\Entity\DrvPndDriverCurStatus
 *
 * @Table(name="drv_pnd_driver_cur_status")
 * @Entity
 */
class DrvPndDriverCurStatus
{
    /**
     ...
     * @SequenceGenerator(sequenceName="drv_pnd_driver_cur_status_guardian_id_seq", allocationSize="1", initialValue="1")
     */
    private $guardianId;
