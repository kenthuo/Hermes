...
/**
 * Contigo\DomainBundle\Entity\Locate200705B5to10k
 *
 * @Table(name="locate_200705_b5to10k")
 * @Entity
 */
class Locate200705B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="locate_200705_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
