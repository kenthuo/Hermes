...
/**
 * Contigo\DomainBundle\Entity\ActionSpeedThresholdHistory
 *
 * @Table(name="action_speed_threshold_history")
 * @Entity
 */
class ActionSpeedThresholdHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_speed_threshold_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
