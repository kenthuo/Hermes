...
/**
 * Contigo\DomainBundle\Entity\LandmarkHistory
 *
 * @Table(name="landmark_history")
 * @Entity
 */
class LandmarkHistory
{
     ...
     * @SequenceGenerator(sequenceName="landmark_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
