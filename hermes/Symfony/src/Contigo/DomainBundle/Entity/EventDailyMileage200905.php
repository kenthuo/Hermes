...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200905
 *
 * @Table(name="event_daily_mileage_200905")
 * @Entity
 */
class EventDailyMileage200905
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200905_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
