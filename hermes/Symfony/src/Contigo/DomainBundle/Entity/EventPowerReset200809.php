...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200809
 *
 * @Table(name="event_power_reset_200809")
 * @Entity
 */
class EventPowerReset200809
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200809_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
