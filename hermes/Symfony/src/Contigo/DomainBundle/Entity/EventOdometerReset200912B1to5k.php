...
/**
 * Contigo\DomainBundle\Entity\EventOdometerReset200912B1to5k
 *
 * @Table(name="event_odometer_reset_200912_b1to5k")
 * @Entity
 */
class EventOdometerReset200912B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_odometer_reset_200912_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
