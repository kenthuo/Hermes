...
/**
 * Contigo\DomainBundle\Entity\OrganizationHistory
 *
...
class OrganizationHistory
{
     ...
     * @SequenceGenerator(sequenceName="organization_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
     ...
     *
     * @Column(name="is_dept_enabled", type="boolean", nullable=true)
     */
