...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200809B10to15k
 *
 * @Table(name="event_startstop_200809_b10to15k")
 * @Entity
 */
class EventStartstop200809B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200809_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
