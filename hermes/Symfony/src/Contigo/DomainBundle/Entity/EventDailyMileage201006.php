...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201006
 *
 * @Table(name="event_daily_mileage_201006")
 * @Entity
 */
class EventDailyMileage201006
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201006_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
