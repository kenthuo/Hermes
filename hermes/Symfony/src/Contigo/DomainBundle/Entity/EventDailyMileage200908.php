...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200908
 *
 * @Table(name="event_daily_mileage_200908")
 * @Entity
 */
class EventDailyMileage200908
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200908_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
