...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200906
 *
 * @Table(name="event_auxalarm_200906")
 * @Entity
 */
class EventAuxalarm200906
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200906_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
