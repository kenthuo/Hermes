...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201004
 *
 * @Table(name="event_power_reset_201004")
 * @Entity
 */
class EventPowerReset201004
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201004_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
