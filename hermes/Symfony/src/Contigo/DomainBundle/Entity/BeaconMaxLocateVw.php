...
/**
 * Contigo\DomainBundle\Entity\BeaconMaxLocateVw
 *
 * @Table(name="beacon_max_locate_vw")
 * @Entity
 */
class BeaconMaxLocateVw
{
    /**
     * @var bigint $beaconId
     *
     ...
     * @SequenceGenerator(sequenceName="beacon_max_locate_vw_beacon_id_seq", allocationSize="1", initialValue="1")
     */
    private $beaconId;
    ...
    /**
     * @var bigint $lastInTcpAudit
     *
     * @Column(name="last_in_tcp_audit", type="bigint", nullable=true)
     */
    private $lastInTcpAudit;

    /**
     * @var bigint $lastInSmsAudit
     *
     * @Column(name="last_in_sms_audit", type="bigint", nullable=true)
     */
    private $lastInSmsAudit;
    ...
    /**
     * @var bigint $lastActivityTimestamp
     *
     * @Column(name="last_activity_timestamp", type="bigint", nullable=true)
     */
    private $lastActivityTimestamp;

    /**
     * @var bigint $lastInUdpAudit
     *
     * @Column(name="last_in_udp_audit", type="bigint", nullable=true)
     */
    private $lastInUdpAudit;
    ...
    /**
     * @var bigint $lockedGpsCounter
     *
     * @Column(name="locked_gps_counter", type="bigint", nullable=true)
     */
    private $lockedGpsCounter;

    /**
     * @var boolean $isAsleep
     *
     * @Column(name="is_asleep", type="boolean", nullable=true)
     */
    private $isAsleep;

    /**
     * @var bigint $lastAsleepTimestamp
     *
     * @Column(name="last_asleep_timestamp", type="bigint", nullable=true)
     */
    private $lastAsleepTimestamp;
