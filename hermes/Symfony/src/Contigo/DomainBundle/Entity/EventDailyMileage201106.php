...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201106
 *
 * @Table(name="event_daily_mileage_201106")
 * @Entity
 */
class EventDailyMileage201106
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201106_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
