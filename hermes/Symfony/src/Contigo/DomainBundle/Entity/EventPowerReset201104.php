...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201104
 *
 * @Table(name="event_power_reset_201104")
 * @Entity
 */
class EventPowerReset201104
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201104_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
