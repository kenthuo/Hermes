...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201006
 *
 * @Table(name="event_power_reset_201006")
 * @Entity
 */
class EventPowerReset201006
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201006_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
