...
/**
 * Contigo\DomainBundle\Entity\EventDailyStatus
 *
 * @Table(name="event_daily_status")
 * @Entity
 */
class EventDailyStatus
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_status_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
