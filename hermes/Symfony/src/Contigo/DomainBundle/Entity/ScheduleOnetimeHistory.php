...
/**
 * Contigo\DomainBundle\Entity\ScheduleOnetimeHistory
 *
 * @Table(name="schedule_onetime_history")
 * @Entity
 */
class ScheduleOnetimeHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="schedule_onetime_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
