...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201105
 *
 * @Table(name="event_auxalarm_201105")
 * @Entity
 */
class EventAuxalarm201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
