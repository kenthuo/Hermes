...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm201005
 *
 * @Table(name="event_auxalarm_201005")
 * @Entity
 */
class EventAuxalarm201005
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_201005_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
