...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201003
 *
 * @Table(name="event_daily_mileage_201003")
 * @Entity
 */
class EventDailyMileage201003
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201003_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
