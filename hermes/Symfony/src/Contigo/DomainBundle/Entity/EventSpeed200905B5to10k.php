...
/**
 * Contigo\DomainBundle\Entity\EventSpeed200905B5to10k
 *
 * @Table(name="event_speed_200905_b5to10k")
 * @Entity
 */
class EventSpeed200905B5to10k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_speed_200905_b5to10k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
