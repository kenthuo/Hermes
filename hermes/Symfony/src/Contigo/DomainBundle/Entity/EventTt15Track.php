...
/**
 * Contigo\DomainBundle\Entity\EventTt15Track
 *
 * @Table(name="event_tt15_track")
 * @Entity
 */
class EventTt15Track
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_tt15_track_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
    ...
    /**
     * @var string $zoneStatus
     *
     * @Column(name="zone_status", type="string", nullable=true)
     */
    private $zoneStatus;

    /**
     * @var string $extendedGpsStatus
     *
     * @Column(name="extended_gps_status", type="string", nullable=true)
     */
    private $extendedGpsStatus;

    /**
     * @var string $speedStatus
     *
     * @Column(name="speed_status", type="string", nullable=true)
     */
    private $speedStatus;

    /**
     * @var string $scheduledHoursFlag
     *
     * @Column(name="scheduled_hours_flag", type="string", nullable=true)
     */
    private $scheduledHoursFlag;
