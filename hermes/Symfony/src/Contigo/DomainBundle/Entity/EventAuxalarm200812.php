...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200812
 *
 * @Table(name="event_auxalarm_200812")
 * @Entity
 */
class EventAuxalarm200812
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200812_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
