...
/**
 * Contigo\DomainBundle\Entity\EventStartstop
 *
 * @Table(name="event_startstop")
 * @Entity
 */
class EventStartstop
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
