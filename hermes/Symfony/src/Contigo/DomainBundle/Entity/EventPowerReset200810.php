...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200810
 *
 * @Table(name="event_power_reset_200810")
 * @Entity
 */
class EventPowerReset200810
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200810_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
