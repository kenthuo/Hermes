...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201001
 *
 * @Table(name="event_power_reset_201001")
 * @Entity
 */
class EventPowerReset201001
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201001_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
