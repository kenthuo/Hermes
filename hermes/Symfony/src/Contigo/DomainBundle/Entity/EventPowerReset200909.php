...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset200909
 *
 * @Table(name="event_power_reset_200909")
 * @Entity
 */
class EventPowerReset200909
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_200909_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
