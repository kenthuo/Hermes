...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndConnectionAudit201102
 *
 * @Table(name="dispatch_api_pnd_connection_audit_201102")
 * @Entity
 */
class DispatchApiPndConnectionAudit201102
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_connection_audit_201102_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
