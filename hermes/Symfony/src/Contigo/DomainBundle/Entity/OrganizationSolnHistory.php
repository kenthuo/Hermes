...
/**
 * Contigo\DomainBundle\Entity\OrganizationSolnHistory
 *
 * @Table(name="organization_soln_history")
 * @Entity
 */
class OrganizationSolnHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="organization_soln_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
