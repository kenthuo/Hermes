...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201105
 *
 * @Table(name="event_daily_mileage_201105")
 * @Entity
 */
class EventDailyMileage201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
