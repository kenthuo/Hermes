...
/**
 * Contigo\DomainBundle\Entity\Stepp2Odometer201009
 *
 * @Table(name="stepp2_odometer_201009")
 * @Entity
 */
class Stepp2Odometer201009
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="stepp2_odometer_201009_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
