...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndMsgAudit201106
 *
 * @Table(name="dispatch_api_pnd_msg_audit_201106")
 * @Entity
 */
class DispatchApiPndMsgAudit201106
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_msg_audit_201106_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
