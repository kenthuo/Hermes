...
/**
 * Contigo\DomainBundle\Entity\EventStartstop200909B1to5k
 *
 * @Table(name="event_startstop_200909_b1to5k")
 * @Entity
 */
class EventStartstop200909B1to5k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_startstop_200909_b1to5k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
