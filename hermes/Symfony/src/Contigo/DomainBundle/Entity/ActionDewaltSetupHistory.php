...
/**
 * Contigo\DomainBundle\Entity\ActionDewaltSetupHistory
 *
 * @Table(name="action_dewalt_setup_history")
 * @Entity
 */
class ActionDewaltSetupHistory
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="action_dewalt_setup_history_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
