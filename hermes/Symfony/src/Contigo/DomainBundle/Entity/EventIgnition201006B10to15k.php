...
/**
 * Contigo\DomainBundle\Entity\EventIgnition201006B10to15k
 *
 * @Table(name="event_ignition_201006_b10to15k")
 * @Entity
 */
class EventIgnition201006B10to15k
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_ignition_201006_b10to15k_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
