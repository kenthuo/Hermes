...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201002
 *
 * @Table(name="event_daily_mileage_201002")
 * @Entity
 */
class EventDailyMileage201002
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201002_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
