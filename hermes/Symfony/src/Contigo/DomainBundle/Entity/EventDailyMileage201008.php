...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage201008
 *
 * @Table(name="event_daily_mileage_201008")
 * @Entity
 */
class EventDailyMileage201008
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_201008_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
