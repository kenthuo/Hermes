...
/**
 * Contigo\DomainBundle\Entity\DispatchApiPndJobAudit201105
 *
 * @Table(name="dispatch_api_pnd_job_audit_201105")
 * @Entity
 */
class DispatchApiPndJobAudit201105
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="dispatch_api_pnd_job_audit_201105_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
