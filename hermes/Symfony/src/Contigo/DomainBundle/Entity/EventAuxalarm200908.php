...
/**
 * Contigo\DomainBundle\Entity\EventAuxalarm200908
 *
 * @Table(name="event_auxalarm_200908")
 * @Entity
 */
class EventAuxalarm200908
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_auxalarm_200908_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
