...
/**
 * Contigo\DomainBundle\Entity\EventDailyMileage200807
 *
 * @Table(name="event_daily_mileage_200807")
 * @Entity
 */
class EventDailyMileage200807
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_daily_mileage_200807_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
