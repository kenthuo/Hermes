...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201012
 *
 * @Table(name="event_power_reset_201012")
 * @Entity
 */
class EventPowerReset201012
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201012_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
