...
/**
 * Contigo\DomainBundle\Entity\EventPowerReset201002
 *
 * @Table(name="event_power_reset_201002")
 * @Entity
 */
class EventPowerReset201002
{
    /**
     * @var bigint $id
     *
     ...
     * @SequenceGenerator(sequenceName="event_power_reset_201002_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
