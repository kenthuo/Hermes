...
class BeaconHistory
{
	 ...
	 * @ORM\SequenceGenerator(sequenceName="beacon_history_seq", initialValue="1", allocationSize="1")
	 */
    protected $id;   
    ...
    /**
	 * @ORM\Column(type="bigint", nullable=false) 
     * @ORM\ManyToOne(targetEntity="Beacon")
     * @ORM\JoinColumn(name="xid", referencedColumnName="id")
     * @Assert\Type(type="Contigo\ModelBundle\Entity\Beacon")
     */
    protected $beacon;  
    ...
    /**
     * @ORM\Column(name="access_list_id", type="bigint")
     */    
    protected $accessListId;    
     ...
     * Set accessListId
     *
     * @param bigint $accessListId
     */
    public function setAccessListId($accessListId)
    {
     ...
     * Get accessListId
     *
     * @return bigint $accessListId
     */
    public function getAccessListId()
    {
