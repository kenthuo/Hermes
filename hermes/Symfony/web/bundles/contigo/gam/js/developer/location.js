$(document).ready(function() {
	...
	var listTableElemId = 'location-list-table'; 
	...
	var addDialog = new SimpleFormDialogFactory(gConstant.ADD_POPUP_DOM_ID, 'Add Location', "Save", "entity-add-form", 600, 300);
	
	// initialize the update dialog
	var updateDialog = new SimpleFormDialogFactory(gConstant.UPDATE_POPUP_DOM_ID, 'Update Location', "Save", "entity-update-form", 600, 300);
