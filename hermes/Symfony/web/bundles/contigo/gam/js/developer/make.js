$(document).ready(function() {
	...
	var listTableElemId = 'make-list-table'; 
	...
	var addDialog = new SimpleFormDialogFactory(gConstant.ADD_POPUP_DOM_ID, 'Add Make', "Save", "entity-add-form", 600, 350);
	
	// initialize the update dialog
	var updateDialog = new SimpleFormDialogFactory(gConstant.UPDATE_POPUP_DOM_ID, 'Update Make', "Save", "entity-update-form", 600, 350);
