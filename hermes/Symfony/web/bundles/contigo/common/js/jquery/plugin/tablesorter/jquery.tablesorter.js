 ...
 * 
 * NOTE: this is a modified version of tablesorter plugin in order to make it
 * working with tablesorter filter plugin. Original latest version can be
 * downloaded from http://tablesorter.com/docs/
 * K.H.: 06/25/2011
 */
/**
 *
